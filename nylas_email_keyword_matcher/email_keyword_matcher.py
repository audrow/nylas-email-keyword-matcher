...
class NylasEmailKeywordMatcher:
    ...
    def run_once(
        ...
        while response is None:
            self._send_keyword_email(subject=subject, message=message, *to)
            try:
